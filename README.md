...
#### `АдресУстройства (Adr)`
Число от 0 до 159. Адрес устройства, как он прописан настройках весов.
...
Только чтение. Значение флана обновляется при считывании веса (вызов функции `ПолучитьВес()`).
#### `ВторойДатчик (Scale2)`
...
Булево - если устновлен флаг, то переданные и полученные данные от устройства будут писаться в лог файл, путь до
